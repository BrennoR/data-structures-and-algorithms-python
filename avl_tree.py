...
# TODO Edit deletion method to update balance and rebalance if necessary
...
class AVLTreeNode(TreeNode):
    ...
    def __init__(self, key, val, parent=None, balance_factor=0):
        super().__init__(key, val, parent)
